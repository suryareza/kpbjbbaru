  ...
  <div class="bg-white container-sm col-6 border my-3 rounded px-5 py-3 pb-5">
    ...
    <div class="card mt-3">
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Menu GH</li>
        @endif
        @if(Auth::user()->role == 'MGR')
        <li class="list-group-item">Menu Manager</li>
        @endif
        @if(Auth::user()->role == 'SPV')
        <li class="list-group-item">Menu Supervisor</li>
        @endif
        @if(Auth::user()->role == 'Staff')
        <li class="list-group-item">Menu Staff</li>
        @endif
        @if(Auth::user()->role == 'QA')
        <li class="list-group-item">Menu QA</li>
        @endif
    </ul>
    </div>
